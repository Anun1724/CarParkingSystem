        ...
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <nav>
                <ul class="flex space-x-6">
                    ...
                    <li><a href="customer_vehicles.php" class="text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Vehicles</a></li>
                ...
                parkingSlots.forEach(slot => {
                    ...
                    slotDiv.innerHTML = `
                        ...
                        <div class="slot-info text-white mt-2">
                            ${slot.isOccupied ? `${slot.vehicleNumber} <br> (Occupied)` : 'Available'}
                        </div>
                    `;
